  ...
  async activate(state) {
	...
	promptForLogin() {
		...
		this.loginView.open(async (token) => {
			...
			this.instantiateBottomPanel()
			await this.getInstanceObject()
			// TODO dismiss the login view...
		})

		// const loginArea = document.createElement('div')

		// loginArea.innerHTML = `
		// 	<h1>Login to Zesty.io</h1>
		// 	<form name="zestyLogin">
		// 		<label>
		// 			<p>Email Address</p>
		// 			<input tabindex="1" type="text" name="email" placeholder="hello@zesty.io" autofocus="true">
		// 		</label>
		// 		<label>
		// 			<p>Password</p>
		// 			<input tabindex="2" type="password" name="pass">
		// 		</label>
		// 		<button id="zestyLoginButton" tabindex="3">Log In</button>
		// 	</form>
		// `
		...
		// const loginModal = atom.workspace.addModalPanel({
		// 	item: loginArea,
		// 	visible: false
		// })
