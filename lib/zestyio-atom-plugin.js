...
export default {
	...
	async updateFileContext(editor) {
		...
		if (breakdown.isZestyFile) {
			...
			cb = () => this.filePublish(breakdown)
		}

		


		this.zestyioAtomPluginView.updateFileContextView(breakdown, webEngineRoutes, auditTrailEntries, cb) // populate after web engine  request
		...
		this.zestyioAtomPluginView.updateFileContextView(breakdown, webEngineRoutes, auditTrailEntries, cb) // populate after audit trail request
